...
public class EncounterManager : MonoBehaviour
{
	...
	public void RandomEncounter()
	{
		if (RandomEncounters != null)
		{
			...
			GameAnalyticsOrion.Instance.TrackEncounter("random", encounter);
	...
	public void OptionalEncounter()
	{
		if (OptionalEncounters != null)
		{
			...
			GameAnalyticsOrion.Instance.TrackEncounter("optional", encounter);
		}
	}
	...
	public void ChoiceCausesDamage(DataVariable data)
	{
		...
		// GameAnalyticsOrion.Instance.TrackChoice("optional", _ActiveEncounter.Value, data);
	}
